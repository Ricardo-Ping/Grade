...
def parse_args():
    ...
    parser.add_argument('--ssl_temp', type=float, default=0.2, help='temperature coefficient.')
    ...
    parser.add_argument('--noise_alpha', type=int, default=0.3, help='noise weight')
    parser.add_argument('--ssl_temp2', type=float, default=0.2, help='temperature coefficient.')
    # 一些默认参数
